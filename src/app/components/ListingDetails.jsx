...
const ListingDetails = ({ listing, isSeller }) => {
  ...
  return (
    <div>
      <div className="relative flex flex-col bg-slate-200 h-120 sm:max-h-125 rounded-lg p-4 py-6 overflow-y-auto no-scrollbar min-h-screen">
        ...
        <div>
          Delivery details: <br />
          Shipping from {formatPrice(deliveryCharge)} to {location}
        </div>
