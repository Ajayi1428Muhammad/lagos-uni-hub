/*
  ...
  - Added the required column `userId` to the `SearchHistory` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "SearchHistory" ADD COLUMN     "userId" TEXT NOT NULL;
...
-- CreateIndex
CREATE INDEX "SearchHistory_count_idx" ON "SearchHistory"("count");
